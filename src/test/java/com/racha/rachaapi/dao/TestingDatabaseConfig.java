...
public class TestingDatabaseConfig {
    ...
    private static final String DB_PORT =
            Objects.requireNonNullElse(System.getenv("DB_PORT"), "5431");
    private static final String DB_NAME =
            Objects.requireNonNullElse(System.getenv("DB_NAME"), "RachaTesting");
    ...
    public void setup() {
        if (System.getenv("DB_HOST") == null) {
            ...
            adminDataSource.setUrl("jdbc:postgresql://localhost:5431/postgres");
